...
from src.components.model_trainer import ModelTrainerConfig, ModelTrainder
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            # CSV в корне проекта (рядом с src/)
            project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
            csv_path = os.path.join(project_root, 'StudentsPerformance.csv')
